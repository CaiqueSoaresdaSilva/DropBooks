...
public class CadastroServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           String i = "INSERT INTO usuario(cpf_cnpj, tipoPessoa, dataNascimento, sexo, email, telefone, nomeRazao, cep, logradouro, numero, complemento, estado, cidade, bairro, senha,Nivel_Usuario, Ativo, banco, agencia, conta, digito) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
            ...
            out.println("<h1>Meu parametro foi " + user.getCpf_cnpj() + " </h1>");
            out.println("<h1>Meu parametro foi " + user.getNivel_usuario()+ " </h1>");
            out.println("<h1>Meu parametro foi " + user.getBanco()+ " </h1>");
            out.println("<h1>Meu parametro foi " + user.getAgencia()+ " </h1>");
            out.println("<h1>Meu parametro foi " + user.getConta()+ " </h1>");
            out.println("<h1>Meu parametro foi " + user.getDigito()+ " </h1>");
